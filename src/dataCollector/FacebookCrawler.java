...
public class FacebookCrawler {
	...
	public static void fetchCommentsToFile(String pageID, String folderPath, String token) throws IOException {
	...
	public static void quickClean(String input, String output) throws IOException{
		BufferedReader br = new BufferedReader( new FileReader(input+".txt") );
		BufferedWriter bw = new BufferedWriter( new FileWriter (input+"clean.txt"));
		
		String line;
		while((line = br.readLine())!=null){
			if (line.replace("?", "").length() <  line.length() - 5){
...
//		fetchCommentsToFile("SusuSwamy", "Rawdata", "366376573541379|bOLAcwpD4do6E5ICztNP0ADp6xo");
		quickClean("Rawdata/narendramodi_comments", "");
		quickClean("Rawdata/SusuSwamy_comments", "");
		quickClean("Rawdata/TimesofIndia_comments", "");
	}
}
